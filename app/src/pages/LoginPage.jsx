 ...
 * Redirects users based on profile completion and role
 */
...
export default function LoginPage() {
   ...
   * Authenticates user and redirects based on profile status and role
   */
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.user && response.user.profileComplete === false && response.user.role !== 'admin') {
        ...
        // Regular user goes to main dashboard
        navigate('/dashboard');
      }
    } catch (err) {
